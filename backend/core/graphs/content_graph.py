...
from core.orchestrators.content.carousel_generator import screenshot_slides_fabric_node
...
def build_content_graph() -> StateGraph:
    ...
    graph.add_node("screenshot_slides",  screenshot_slides_fabric_node)
    ...
    graph.add_edge("fetch_images",     "screenshot_slides")
