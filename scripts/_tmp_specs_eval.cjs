...
const TEMPLATE_CONTENT_SPECS= [
...

  {
    ...
    textFields: [
      { field: "title", label: "Hook headline", font: "Inter Black 900", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
    ],
    images: [],
  },

  {
    ...
    contentStyle: "Title, sets the key idea. Body: 30–55 words of specific, actionable insight. No generics.",
    ...
    textFields: [
      { field: "title", label: "Slide title", font: "Inter 700", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
      { field: "body", label: "Body copy", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "body" },
    ],
    images: [
      { field: "image_url", required, aspectRatio: "4:3",
        minWidth, purpose: "Supporting visual — chart, diagram, or relevant photo" },
    ],
  },

  {
    ...
    textFields: [
      { field: "stat_value", label: "The number", font: "Inter Black 900", fontSize,
        maxChars, targetChars, minChars, multiline, style: "number" },
      { field: "stat_label", label: "What it measures", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "caption" },
      { field: "title", label: "Context sentence", font: "Inter 700", fontSize,
        maxChars, targetChars, minChars, multiline, style: "body" },
    ],
    images: [],
  },

  {
    ...
    textFields: [
      { field: "title", label: "The quote", font: "Inter Italic 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "body" },
      { field: "body", label: "Attribution", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "attribution" },
    ],
    images: [],
  },

  {
    ...
    textFields: [
      { field: "title", label: "CTA headline", font: "Inter Black 700", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
      { field: "body", label: "Supporting copy", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "body" },
    ],
    images: [],
  },

  {
    ...
    textFields: [
      { field: "title", label: "Engage prompt", font: "Inter Black 700", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
      { field: "body", label: "Value reinforcement", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "body" },
    ],
    images: [],
  },
...

  {
    ...
    textFields: [
      { field: "title", label: "Hook headline", font: "Inter Black 900", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
      { field: "body", label: "Sub-label (optional)", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "caption" },
    ],
    images: [],
  },

  {
    ...
    textFields: [
      { field: "compact_meta.baseline_stat", label: "Baseline number", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "number" },
      { field: "compact_meta.featured_stat", label: "Featured number", font: "Inter 700", fontSize,
        maxChars, targetChars, minChars, multiline, style: "number" },
      { field: "compact_meta.body_header", label: "Contrast headline", font: "Inter 700", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
    ],
    images: [],
  },

  {
    ...
    textFields: [
      { field: "compact_meta.left_stat",   label: "Left value",  font: "Inter Black 900", fontSize,
        maxChars, targetChars, minChars, multiline, style: "number" },
      { field: "compact_meta.right_stat",  label: "Right value", font: "Inter Black 900", fontSize,
        maxChars, targetChars, minChars, multiline, style: "number" },
      { field: "compact_meta.left_label",  label: "Left label",  font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "caption" },
      { field: "compact_meta.right_label", label: "Right label", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "caption" },
    ],
    images: [],
  },

  {
    ...
    textFields: [
      { field: "compact_meta.step_number", label: "Step number", font: "Inter Black 900", fontSize,
        maxChars, targetChars, minChars, multiline, style: "number" },
      { field: "title", label: "Step title", font: "Inter Black 900", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
      { field: "body", label: "Step description", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "body" },
    ],
    images: [],
  },

  {
    ...
    textFields: [
      { field: "compact_meta.steps", label: "Step labels (array of 3–6 items)", font: "Inter 700", fontSize,
        maxChars, targetChars, minChars, multiline, style: "caption" },
    ],
    images: [
      { field: "compact_meta.image_url", required, aspectRatio: "1:1",
        minWidth, purpose: "Atmospheric landscape or abstract photo for dark overlay background" },
    ],
  },

  {
    ...
    exampleContent: "Title: 'Build your evidence stack'. Body: 'Collect 5 data points that support your hypothesis, competitor analysis, market size data, technical feasibility notes, and at least one contrarian view. Document sources for every claim.'",
    textFields: [
      { field: "title", label: "Step title", font: "Inter Black 900", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
      { field: "body", label: "Step detail", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "body" },
    ],
    images: [
      { field: "compact_meta.image_url", required, aspectRatio: "1:1",
        minWidth, purpose: "Relevant atmospheric photo for background — landscape, workspace, or abstract" },
    ],
  },

  {
    ...
    textFields: [
      { field: "compact_meta.stat_value", label: "Headline number", font: "Inter Black 900", fontSize,
        maxChars, targetChars, minChars, multiline, style: "number" },
      { field: "compact_meta.stat_label", label: "What it measures", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "caption" },
      { field: "title", label: "Context line", font: "Inter 700", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
    ],
    images: [
      { field: "compact_meta.image_url", required, aspectRatio: "1:1",
        minWidth, purpose: "Full-bleed atmospheric photo contextually related to the stat topic" },
    ],
  },

  {
    ...
    textFields: [
      { field: "compact_meta.items", label: "List items (array, each with title + description)", font: "Playfair Display 700", fontSize,
        maxChars, targetChars, minChars, multiline, style: "body" },
    ],
    images: [],
  },

  {
    ...
    textFields: [
      { field: "compact_meta.quote_body",        label: "The quote",    font: "Playfair Display Bold Italic", fontSize,
        maxChars, targetChars, minChars, multiline, style: "body" },
      { field: "compact_meta.quote_attribution", label: "Attribution",  font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "attribution" },
    ],
    images: [
      { field: "compact_meta.image_url", required, aspectRatio: "9:16",
        minWidth, purpose: "B&W portrait photo of the person being quoted, or thematically related portrait" },
    ],
  },
...

  {
    ...
    textFields: [
      { field: "compact_meta.pill_text", label: "Pill label (ALL CAPS)", font: "Inter 700", fontSize,
        maxChars, targetChars, minChars, multiline, style: "pill_label" },
      { field: "title", label: "CTA headline", font: "Inter Black 900", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
      { field: "body", label: "Handle + cadence", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "caption" },
    ],
    images: [],
  },

  {
    ...
    textFields: [
      { field: "title", label: "Quote text", font: "Playfair Display Bold Italic", fontSize,
        maxChars, targetChars, minChars, multiline, style: "body" },
      { field: "body", label: "Attribution", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "attribution" },
    ],
...

  {
    ...
    textFields: [
      { field: "compact_meta.pill_text", label: "Action pill (ALL CAPS)", font: "Inter 700", fontSize,
        maxChars, targetChars, minChars, multiline, style: "pill_label" },
      { field: "title", label: "Action headline", font: "Inter Black 900", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
      { field: "body", label: "Supporting copy", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "body" },
    ],
...

  {
    ...
    textFields: [
      { field: "title", label: "Essay-style opening", font: "Playfair Display Bold Italic", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
      { field: "body", label: "Framing sentence", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "body" },
      { field: "compact_meta.handle",       label: "@handle",      font: "Inter 300", fontSize,
        maxChars, targetChars, minChars, multiline, style: "handle" },
      { field: "compact_meta.series_title", label: "Series title", font: "Playfair Italic", fontSize,
        maxChars, targetChars, minChars, multiline, style: "caption" },
    ],
    images: [],
  },
...

  {
    ...
    contentStyle: "pill_text: 2–4 ALL-CAPS words (max 20 chars). headline, period at end (max 40 chars). sub_text: handle + cadence (max 60 chars).",
    exampleContent: "pill_text: 'FOLLOW FOR MORE'. headline: 'Follow for more.' sub_text: '@yourbrand · Every Sunday'",
    textFields: [
      { field: "compact_meta.pill_text", label: "Pill label (ALL CAPS)", font: "Inter 700", fontSize,
        maxChars, targetChars, minChars, multiline, style: "pill_label" },
      { field: "title", label: "CTA command", font: "Inter Black 900", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
      { field: "body", label: "Handle + cadence", font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "caption" },
    ],
...

  {
    ...
    contentStyle: "headline, 1–3 words per line, 2 lines max (max 40 chars total). body_text: one punchy supporting line (max 80 chars). screen_image: the product/app screenshot for the phone screen.",
    exampleContent: "headline: 'YOUR HEADLINE\\nGOES HERE'. body_text: 'One idea. One slide. Maximum impact.'",
    textFields: [
      { field: "compact_meta.headline",  label: "Display headline", font: "Inter Black 900", fontSize,
        maxChars, targetChars, minChars, multiline, style: "headline" },
      { field: "compact_meta.body_text", label: "Supporting line",  font: "Inter 400", fontSize,
        maxChars, targetChars, minChars, multiline, style: "body" },
    ],
    images: [
      { field: "compact_meta.screen_image_url", required, aspectRatio: "9:16",
        minWidth, purpose: "App or product screenshot for the phone mockup screen" },
    ],
  },

  {
    ...
    images: [
      { field: "compact_meta.image_urls[0]", required, aspectRatio: "free",
        minWidth, purpose: "First photo — left/main tilted slot" },
      { field: "compact_meta.image_urls[1]", required, aspectRatio: "free",
        minWidth, purpose: "Second photo — right/smaller tilted slot" },
    ],
  },
];
...
const TEMPLATE_CONTENT_SPEC_MAP, TemplateContentSpec> =
  Object.fromEntries(TEMPLATE_CONTENT_SPECS.map(s => [s.templateId, s]));

/** Get spec for a template, or null if not found */
function getTemplateContentSpec(templateId): TemplateContentSpec | null {
  return TEMPLATE_CONTENT_SPEC_MAP[templateId] ?? null;
}

console.log(JSON.stringify({ specs: TEMPLATE_CONTENT_SPECS, generated_at: new Date().toISOString() }, null, 2));